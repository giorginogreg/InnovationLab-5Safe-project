...
def test_level(colored_logger: ColoredLogger, level: int, expected_level: int) -> None:
    colored_logger.setLevel(level)
    assert colored_logger.level == expected_level


# def test_success(colored_logger: ColoredLogger, caplog: pytest.LogCaptureFixture) -> None:
...
# def test_warning(colored_logger: ColoredLogger, caplog: pytest.LogCaptureFixture) -> None:
...
# def test_error(colored_logger: ColoredLogger, caplog: pytest.LogCaptureFixture) -> None:
...
# def test_critical(colored_logger: ColoredLogger, caplog: pytest.LogCaptureFixture) -> None:
