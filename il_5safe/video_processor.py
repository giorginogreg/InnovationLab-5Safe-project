...
def process_video(video_path: str, yolov5: Any, output_data_directory: str) -> None:
    """
    ...
    while video_capture.isOpened():
        ...
        filtered_results: pd.DataFrame = filtered_results[(filtered_results['class'] == 'bicycle') | (filtered_results['class'] == 'person')]
        np.save(f"{output_data_directory}/frame_{frame_count}", filtered_results.to_numpy())
        results.save()
