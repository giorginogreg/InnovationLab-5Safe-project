...
def CreateWidgets():
    ...
    show_Button = Button(root, text="Show result", font=helv15, bg="#E8D579",
                         command= lambda: Showimg(fileName), width=50, height=1)
...
def Showimg(fileName):
    ...
    os.system("open ../models/yolov5/runs/detect/exp/"+fileName)
...
def CopyFile():
    ...
    destination_location = "../models/yolov5/data/images"
    ...
    os.system("python ../models/yolov5/detect.py --weights ../models/yolov5/runs/train/exp/weights/best.pt")
    #files = glob.glob('../models/yolov5/data/images/*')
    #for f in files:
    #    os.remove(f)
